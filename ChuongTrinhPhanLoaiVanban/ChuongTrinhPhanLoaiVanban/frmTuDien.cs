...
namespace ChuongTrinhPhanLoaiVanban
{
    public partial class frmTuDien : Form
    {
        ...
        {
            cboNapTuDien.Items.Add("Từ Điển");
        ...
        private void btnNap_Click(object sender, EventArgs e)
        {
            ...
            if (!File.Exists(path))
            {
                MessageBox.Show("Thiếu từ điển !", path, MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void cboNapTuDien_SelectedIndexChanged(object sender, EventArgs e)
        {
