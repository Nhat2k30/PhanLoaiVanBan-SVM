...
namespace ChuongTrinhPhanLoaiVanban
{
    public partial class frmDuLieu : Form
    {
        ...
        private void btnPhanTich_Click(object sender, EventArgs e)
        {
                ...
                for (int i = 0; i < sArr.Length; i++)
                {
                    ...
                    if (sArr[i].Length > 0)
                    {
                        ...
                        while (world.Length > 0)
                        {
                            ...
                            {
                                //neu tu do co trong tu dien, luu vao tu dien trung gian
            ...
            txtketQuaDuLieu.ScrollToCaret();
            MessageBox.Show("Đã phân tích xong dữ liệu!");
        }
        ...
        private void txtketQuaDuLieu_TextChanged(object sender, EventArgs e)
        {
